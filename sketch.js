...
function setup() {
	...
	leftone = Bodies.rectangle(270, 610, 20, 100, {isStatic:true});
	World.add(world, leftone);

	rightone = Bodies.rectangle(470,610,20,100, {isStatic:true});
	World.add(world, rightone);

	downone = Bodies.rectangle(370,650,200,20, {isStatic:true});
...
function draw(){
  ...
  if (packageSprite.isTouching(rectan))
  {
